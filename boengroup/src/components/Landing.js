...
const titleMargin={marginBottom:'40px', fontSize:'26px'};
...
render() {
  return(
    <div>
      <nav className="navbar navbar-expand-lg navbar-light" style={{fontSize:'20px'}}>
        <a className="navbar-brand" href="#">
       <img src="https://static1.squarespace.com/static/55ff6aece4b0ad2d251b3fee/t/589926e26a496356e7ed635d/1496624236298/SFL-data-science-consulting.png?format=300w" className="d-inline-block align-top fixed" alt="" style={{height:'70px', margin:'0 10px'}}/>
     </a>
    ...
    <div className='container=fluid'>
      <div className="row text-white">
        <div className="col" style={bannerStyle}>
          ...
          <h1 className='text-center display-3 font-italic'>Workforce Training</h1>
            <p className='text-center lead'>Sharpen insights and strengthen outcomes with data analytics</p>
        </div>
      </div>
    </div>
    ...
    <div className='container' style={{}}>
      <div className="row">
        <div className="col" style={colStyle}>
          ...
          <h1 className='text-center display-4 font-italic' style={{marginBottom:'40px', color:'#137CB9'}}>Data Analysis At Your Fingertips</h1>
            <p className="text-center font-weight-light text-secondary lead" style={{padding:'30px', lineHeight:'2', fontSize:'22px'}}>
    ...
    <div className='container-fluid text-white' style={{height:'400px'}}>
      <div className="row" style={{height:'100%'}}>
      <div className="col" style={{backgroundColor:'#48afec', padding:'50px'}}>
          <p className='text-center font-italic' style={titleMargin}>Discretionary Funding</p>
            <p className="text-center font-weight-light" style={{lineHeight:'1.7', fontSize:'23px', letterSpacing:'.7px'}}>
      ...
      <div className="col" style={{backgroundColor:'#4994c8', padding:'50px'}}>
          <p className='text-center font-weight-bold' style={titleMargin}>Benchmarks of Good Performance</p>
            <p className="text-center font-weight-light" style={{lineHeight:'1.7', fontSize:'23px', letterSpacing:'.7px'}}>
              ...
              <div className="col hover" style={colStyle}>
                <img src='././public/groupicon.png'/>
                  <h2 className='text-center' style={titleMargin}>Demographic</h2>
                    <p className="text-center font-weight-bold" style={{fontSize:'23px', letterSpacing:'1px'}}>
          ...
          <div className="col" style={colStyle}>
            <img src='././public/groupicon.png'/>
              <h2 className='text-center' style={titleMargin}>Predictive</h2>
                <p className="text-center font-weight-light" style={{fontSize:'23px'}}>
